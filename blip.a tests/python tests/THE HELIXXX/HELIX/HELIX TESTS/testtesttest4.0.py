...
def draw_rotating_dna(cx, cy, length=1500, amplitude=110, points=110):
    ...
    GLOW_OUTER_RGB = hex_to_rgb(GLOW_OUTER)
    GLOW_MID_RGB   = hex_to_rgb(GLOW_MID)
    GLOW_CORE_RGB  = hex_to_rgb(GLOW_CORE)
    ...
    for i in range(points):
        ...
        create_depth_glowing_dot(x, y1, CORE_RADIUS, t1)
        ...
        create_depth_glowing_dot(x, y2, CORE_RADIUS, t2)
